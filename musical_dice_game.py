...
def construct_waltz():
    ...
    for i in minuet_table:
        minuet.append(i[roll_dice(2)])
    for i in trio_table:
        trio.append(i[roll_dice(1)])
    for i in minuet:
        wave.append(simpleaudio.WaveObject.from_wave_file(minuet_filename(i)))
    for i in trio:
        wave.append(simpleaudio.WaveObject.from_wave_file(trio_filename(i)))
    for i in wave:
        i.play().wait_done()
